...
export default function FackbookInsight() {
    const theme = useTheme();
     ...
     // fetchdatafrom API
      ...
      if (!loading) 
      {
       nivoDataFollowers = createNivoData(fbData, "follower", 'Facebook');
       nivoDataNewFollowers = createNivoData(fbData, "newfollower", 'Facebook');
       formatAgeData = formatDataForNivo(createBarData(fbData,["Facebook"],"age"), ageKeys);
       formatGenderData = formatDataForNivo(createBarData(fbData,["Facebook"],"gender"), keys);
       formatGeoData = createGeographyData(createBarData(fbData,["Facebook"],"country" )[0], twoToThreeLetterCodeMapping);
       console.log("geo",createBarData(fbData,["Facebook"],"country" ));
      }
